...
| **`E52_Time_Span`** | E52 Time-Span | 时间跨度 | `start` / `end` / `label` | `ts_{md5(start+end+label)}` |
...
| **E12_Production** | `P4_has_time_span` | **E52_Time_Span** | 生产具有精确时间跨度 | **新增** (时间转为独立节点) |
| **E25_Man_Made_Feature** | `P108i_was_produced_by` | **E12_Production** | 单位(如墓葬/灰坑)由...构筑/形成 | **新增** |
| **E12_Production** | `P10_falls_within` | **E4_Period** | 生产发生在某一考古时期之内 | **新增** (E52 -> Period 的语义桥接) |
| **E4_Period** | `P7_took_place_at` | **E27_Site** | 时期发生/体现于某遗址 | 保持 V3 |
