...
- **Identity Context (身份指纹)** [IMPORTANT]: Any information that helps uniquely identify this entity. (任何有助于唯一标识该实体的信息)
  ...
  - **Location/Layer (方位/地层)**: "Located in the southwest corner", "Under Layer 3" (位于西南角，开口于③层下).
  - **Cultural Context (文化背景)**: "Belongs to Longshan Culture", "Late Period" (属于龙山文化，晚期). **Capture this explicitly!** (请明确捕捉此信息！)
...
```json
{
  "global_tips": "良渚文化晚期 (Late Liangzhu Culture)",
  "entities": [
    {
      "name": "良渚古城遗址",
      "type": "SITE",
          ...
          "children": [
            {
              "name": "N1城墙段",
              "type": "SUBAREA",
              "entity_tips": "位于北城墙中段。2007年发掘。良渚文化晚期。",
              "related_text": "N1城墙段：位于北城墙中段。2007年发掘。属于良渚文化晚期。此处发现大量堆积。",
              "children": [
                {
                  "name": "TG1",
                  "type": "FEATURE",
...
- **Identity Context** [IMPORTANT]: Any information that helps uniquely identify this entity.
  ...
  - **Location/Layer**: "Located in the southwest corner", "Under Layer 3".
  - **Cultural Context**: "Belongs to Longshan Culture", "Late Period". **Capture this explicitly!**
